...
function addRSS(title, link){
    ...
    if(link.match(/^https*:\/\/rsshub.app/)){
        var rsshub_domain = GM_getValue("rsshub_domain", "https://rsshub.feeded.xyz");
...
window.open("http://192.168.1.112:9222/setting?url=" + encodeURIComponent(link), "_blank");
